...
import com.rynime.nvplayer.domain.model.StorageVolumeInfo
...
import com.rynime.nvplayer.domain.model.WatchHistory
import com.rynime.nvplayer.util.getAvailableStorageVolumes
...
import com.rynime.nvplayer.ui.screens.videolist.state.PathSegment
...
class VideoListViewModel(
                    ...
                    val videos = items.map { item ->
                        ...
                        if (item.size > 0 && item.duration > 0) {
                            ...
                            if (cached != null) {
                                ...
                                val extracted = com.rynime.nvplayer.util.getVideoMetadata(repository.context, item.uri)
                                ...
                                metadataDao.insertOrUpdate(
                                    com.rynime.nvplayer.data.database.CachedVideoMetadata(
                                        uri = uriStr,
                                        size = finalSize,
    ...
    fun selectFolder(folder: VideoFolder?) {
        ...
        if (folder != null) {
            ...
            com.rynime.nvplayer.domain.thumbnail.ThumbnailRepository.getInstance(repository.context)
