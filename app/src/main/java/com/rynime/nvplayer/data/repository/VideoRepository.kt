...
import com.rynime.nvplayer.data.model.FolderItem
import com.rynime.nvplayer.data.model.VideoItem
...
class VideoRepository(
    ...
    val videoMetadataDao = com.rynime.nvplayer.data.database.AppDatabase.getDatabase(context).videoMetadataDao()
        ...
        trashedItems.map { item ->
            ...
            if (item.size > 0 && item.duration > 0) {
                ...
                if (cached != null) {
                    ...
                    val extracted = com.rynime.nvplayer.util.getVideoMetadata(context, item.uri)
