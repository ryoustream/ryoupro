package com.rynime.nvplayer.player.service
...
import com.rynime.nvplayer.MainActivity
...
class MediaPlaybackService : Service() {
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                ...
                ACTION_PREV -> {
                    val broadcastIntent = Intent("com.rynime.nvplayer.PIP_PREV").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
                ACTION_NEXT -> {
                    val broadcastIntent = Intent("com.rynime.nvplayer.PIP_NEXT").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
    ...
    companion object {
        ...
        const val ACTION_TOGGLE_PLAYBACK = "com.rynime.nvplayer.ACTION_TOGGLE_PLAYBACK"
        const val ACTION_STOP = "com.rynime.nvplayer.ACTION_STOP"
        const val ACTION_PREV = "com.rynime.nvplayer.ACTION_PREV"
        const val ACTION_NEXT = "com.rynime.nvplayer.ACTION_NEXT"
        const val ACTION_REWIND = "com.rynime.nvplayer.ACTION_REWIND"
        const val ACTION_FORWARD = "com.rynime.nvplayer.ACTION_FORWARD"
    ...
    override fun onCreate() {
        ...
        mediaSession = MediaSessionCompat(this, "NokvezPlayMediaSession").apply {
            isActive = true
    ...
    private fun updateNotification() {
        ...
        val metadataBuilder = MediaMetadataCompat.Builder()
            ...
            .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, "Nokvez Play")
